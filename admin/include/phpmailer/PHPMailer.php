 ...
 * PHP Version 5.5.
 *
 * @see       s://github.com/PHPMailer/PHPMailer/ The PHPMailer GitHub project
 *
...
class PHPMailer
{
     ...
     *
     * @see s://tools.ietf.org/html/rfc5322#section-3.6.4
     *
     * @var string
     */
    public $MessageID = '';
     ...
     *
     * @see s://en.wikipedia.org/wiki/Variable_envelope_return_path
     ...
     *
     * @see s://github.com/PHPMailer/PHPMailer/issues/924 CVE-2016-10045 bug report
     *
    ...
    protected function mailSend($header, $body)
    {
        ...
        if (!empty($this->Sender) and static::validateAddress($this->Sender)) {
            ...
            //Example problem: s://www.drupal.org/node/1057954
            // CVE-2016-10033, CVE-2016-10045: Don't pass -f if characters will be escaped.
    ...
    public function createHeader()
    {
        ...
        // s://tools.ietf.org/html/rfc5322#section-3.6.4
        ...
        if ('' == $this->XMailer) {
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer ' . self::VERSION . ' (s://github.com/PHPMailer/PHPMailer)'
            );
        } else {
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                //Workaround for PHP bug s://bugs.php.net/bug.php?id=69197
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' == $key) {
                ...
                return $this->language[$key] . ' s://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting';
            }
    ...
    public static function _mime_types($ext = '')
    {
        $mimes = [
            ...
            'php3' => 'application/x-d-php',
            'php4' => 'application/x-d-php',
            'php' => 'application/x-d-php',
            'phtml' => 'application/x-d-php',
            'phps' => 'application/x-d-php-source',
     ...
     *
     * @see    s://tools.ietf.org/html/rfc6376#section-3.4.2
     *
    ...
    public function DKIM_HeaderC($signHeader)
    {
        ...
        //@see s://tools.ietf.org/html/rfc5322#section-2.2
     ...
     *
     * @see    s://tools.ietf.org/html/rfc6376#section-3.4.3
     *
     * @param string $body Message Body
     *
     * @return string
