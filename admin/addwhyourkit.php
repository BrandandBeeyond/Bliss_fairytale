                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Add New why our kit</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Add why our kit</li>
                                </ol>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="validationCustom01">answer</label>
                                                <textarea name="answer" id="aboutVision-text" class="ckeditor"></textarea>
                                    ...
                                    <?php } else { ?>
                                        <button type="submit" name="addwhyourkit" class="btn btn-primary"><i
