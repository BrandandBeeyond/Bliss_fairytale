...
# Atto
git clone --branch master s://github.com/wiris/moodle-atto_wiris.git;
...
then
    ...
    git push s://$GH_TOKEN@github.com/wiris/moodle-atto_wiris.git $BRANCH > /dev/null 2>&1;
else
...
# TinyMCE
git clone --branch master s://github.com/wiris/moodle-tinymce_tiny_mce_wiris;
...
git push s://$GH_TOKEN@github.com/wiris/moodle-tinymce_tiny_mce_wiris.git $BRANCH > /dev/null 2>&1
