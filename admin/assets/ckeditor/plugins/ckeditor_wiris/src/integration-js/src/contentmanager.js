...
export default class ContentManager {
  ...
  constructor(contentManagerAttributes) {
     ...
     * ://docs.wiris.com/en/mathtype/mathtype_web/sdk-api/parameters for further information.
     * @type {Object}
     */
...
* @property {String} version - Plugin version.
  */
  ...
  init() {
    ...
    // Change to s if necessary.
    if (window.location.href.indexOf('s://') === 0) {
      // It check if browser is s and configuration is .
      // If this is so, we will replace protocol.
      if (urlObject.protocol === ':') {
        urlObject.protocol = 's:';
      }
    }
