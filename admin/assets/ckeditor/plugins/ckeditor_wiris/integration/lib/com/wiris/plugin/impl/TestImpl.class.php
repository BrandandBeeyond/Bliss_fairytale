...
class com_wiris_plugin_impl_TestImpl implements com_wiris_plugin_api_Test{
	...
	public function getTestPage() {
		...
		$condition = true;
		try {
			$h = new com_wiris_plugin_impl_HttpImpl("://www.wiris.net", null);
			$h->request(true);
		}catch(Exception $�e) {
			$_ex_ = ($�e instanceof HException) ? $�e->e : $�e;
			$ex2 = $_ex_;
