...
class com_wiris_plugin_impl_EditorImpl implements com_wiris_plugin_api_Editor{
	...
	public function editor($language, $provider) {
		...
		if(StringTools::startsWith($editorUrl, ":") && $isSegure) {
			$editorUrl = "s:" . _hx_substr($editorUrl, 5, null);
		}
		$this->addLine($output, "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">");
		$this->addLine($output, "<html><head>");
		$this->addLine($output, "<meta -equiv=\"content-type\" content=\"text/html; charset=UTF-8\"/>");
		...
		$this->addLine($output, "<div id=\"links\"><a href=\"://www.wiris.com/editor3/docs/manual/latex-support\" id=\"a_latex\" target=\"_blank\">LaTeX</a> | ");
		$this->addLine($output, "<a href=\"://www.wiris.com/editor3/docs/manual\" target=\"_blank\" id=\"a_manual\">Manual</a></div></div></body>");
		return $output->b;
	}
	public $plugin;
