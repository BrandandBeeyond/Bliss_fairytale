...
class com_wiris_plugin_impl_CasImpl implements com_wiris_plugin_api_Cas{
	...
	public function printCASContainer($config, $availableLanguages, $lang) {
		...
		$output->add("<html><head><meta -equiv=\"content-type\" content=\"text/html; charset=UTF-8\"/><script>");
		$output->add("var lang ='");
		$output->add($lang);
	...
	public function printCAS($codebase, $archive, $className) {
		...
		$output->add("\"><p>You need JAVA&reg; to use WIRIS tools.<br />FREE download from <a target=\"_blank\" href=\"://www.java.com\">www.java.com</a></p></applet></body></html>");
		return $output->b;
	}
	...
	public function cas($mode, $language) {
		$output = new StringBuf();
		$output->add("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">");
