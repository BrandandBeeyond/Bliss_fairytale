...
com.wiris.system.JsDOMUtils.rewriteDefaultPaths = function(contextPath) {
	if(window.com.wiris.js.defaultServicePath != null && StringTools.startsWith(window.com.wiris.js.defaultServicePath,"://")) {
		var protocol = js.Lib.window.location.protocol;
		var defaultServicePathWithoutProtocol = window.com.wiris.js.defaultServicePath.substr(":".length);
		var reg = new EReg("(:|s:)" + defaultServicePathWithoutProtocol + "/" + contextPath,"");
		if(com.wiris.system.JsDOMUtils.findScriptElement(reg) != null) protocol = reg.matched(1);
		if(protocol == "s:") {
			window.com.wiris.js.defaultServicePath = "s:" + defaultServicePathWithoutProtocol;
			if(window.com.wiris.js.defaultBasePath != null) window.com.wiris.js.defaultBasePath = "s:" + window.com.wiris.js.defaultBasePath.substr(":".length);
		}
	}
}
...
com.wiris.system.JsDOMUtils.findServicePath = function(scriptName) {
	...
	if(servicePath != null && StringTools.startsWith(servicePath,"://") && js.Lib.window.location.protocol == "s:") servicePath = "s://" + HxOverrides.substr(servicePath,"://".length,null);
	return servicePath;
}
