...
/**
 * @fileOverview The [Mathematical Formulas](s://ckeditor.com/cke4/addon/mathjax) plugin that allows you to create and modify mathematical equations written in TeX directly in CKEditor..
 */
	...
	CKEDITOR.plugins.add( 'mathjax', {
		...
		init: function( editor ) {
			...
			editor.on( 'paste', function( evt ) {
				...
				// Also iFrame in paste content is reason of "Unspecified error" in IE9 (s://dev.ckeditor.com/ticket/10857).
	...
	if ( !( CKEDITOR.env.ie && CKEDITOR.env.version == 8 ) ) {
		CKEDITOR.plugins.mathjax.frameWrapper = function( iFrame, editor ) {
			...
			function load() {
				...
				// when you undo (s://dev.ckeditor.com/ticket/10930). If you have iFrame with javascript in src
 ...
 * converted into [Mathematical Formulas](s://ckeditor.com/cke4/addon/mathjax)
 * widgets.
 *
