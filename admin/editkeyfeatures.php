...
if (!isset($_SESSION['email'])) {
    ...
    if (isset($_GET['editkeyfeatures'])) {
        ...
        $keyfeatureId = $_GET['editkeyfeatures'];
        $getKeyFeatureSql = "SELECT * FROM key_features WHERE id='$keyfeatureId'";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                                        ...
                                        <!-- Submit Button -->
                                        <button type="submit" name="updateKeyFeature" class="btn btn-primary">
