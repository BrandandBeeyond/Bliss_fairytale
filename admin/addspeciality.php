                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Add New speciality</h4>
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="mb-3">
                                                <label class="form-label" for="validationCustom01">speciality name</label>
                                                <input type="text" class="form-control" id="validationCustom01"
                                                    placeholder="Speciality Name" required name="specialityname">
                                    ...
                                    <?php } else { ?>
                                        <button type="submit" name="addspeciality" class="btn btn-primary"><i
